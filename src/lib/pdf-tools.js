...
export const getPDFReadableStream = async (media) => {
  ...
  const docDefinition = {
    content: [imagePart, { text: media.reviews[0].comment, text: media.reviews[0].rate, fontSize: 20, bold: true, margin: [0, 0, 0, 40] }, { text: striptags(media.reviews[0].id), lineHeight: 2 }],
  }
